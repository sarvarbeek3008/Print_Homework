...
maishiy = InlineKeyboardMarkup(
    row_width=2,
    inline_keyboard=[
        [InlineKeyboardButton("Chang-yutgich",callback_data="Changyutgich"),InlineKeyboardButton("Tifal",callback_data="Tifal"),InlineKeyboardButton("Fen",callback_data="Fen")],
